...
describe("the options page", function () {
    it("loads properly default page", async () => {
        ...
        await page.goto(`chrome-extension://${utils.EXTENSION_ID}/options.html`, { waitUntil: ['domcontentloaded', "networkidle2"] });
