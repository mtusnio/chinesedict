...
test("pressing the copy shortcut puts the definition in clipboard", async () => {
    ...
    expect(clipboardContent).toEqual(`有	有	jau5	yǒu	to have; there is/(bound form) having; with; -ful; -ed; -al (as in 有意[you3 yi4] intentional)
