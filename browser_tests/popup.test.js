...
test("prints out a different HTML when hovering over 有 in an HTML-rich site with a custom config set up", async () => {
    ...
    expect(windowHTML).toEqual("<span class=\"w-hanzi\">有</span>&nbsp;<br><span class=\"tone3 w-zhuyin\">ㄧㄡˇ</span><br><span class=\"w-def\">to have; there is/(bound form) having; with; -ful; -ed; -al (as in 有意[you3 yi4] intentional)</span><br>")
})
...
test("navigation forward and backwards moves between different words", async () => {
    const htmls = {
        ...
        "爸爸": "<span class=\"w-hanzi-small\">爸爸</span>&nbsp;<span class=\"w-pinyin-small tone4\">bà</span>&nbsp;<span class=\"w-pinyin-small tone5\">ba</span>&nbsp;&nbsp;&nbsp;<span class=\"w-pinyin-small\">baa1 baa1</span><br><span class=\"w-def-small\">(coll.) father; dad/CL:個|个[ge4],位[wei4]</span><br><span class=\"w-hanzi-small\">爸</span>&nbsp;<span class=\"w-pinyin-small tone4\">bà</span>&nbsp;&nbsp;&nbsp;<span class=\"w-pinyin-small\">baa1</span><br><span class=\"w-def-small\">father/dad/pa/papa</span><br>",
...
test.each([
    ...
    },
    {
        ...
        expectedHTML: "<span class=\"w-hanzi-small\">機會</span>&nbsp;<span class=\"w-pinyin-small tone1\">jī</span>&nbsp;<span class=\"w-pinyin-small tone4\">huì</span>&nbsp;&nbsp;&nbsp;<span class=\"w-pinyin-small\">gei1 wui5</span><br><span class=\"w-def-small\">opportunity/chance/occasion/CL:個|个[ge4]</span><br><span class=\"w-hanzi-small\">機</span>&nbsp;<span class=\"w-pinyin-small tone1\">Jī</span>&nbsp;&nbsp;&nbsp;<span class=\"w-pinyin-small\">gei1</span><br><span class=\"w-def-small\">surname Ji</span><br><span class=\"w-hanzi-small\">機</span>&nbsp;<span class=\"w-pinyin-small tone1\">jī</span>&nbsp;&nbsp;&nbsp;<span class=\"w-pinyin-small\">gei1</span><br><span class=\"w-def-small\">(bound form) machine; mechanism/(bound form) aircraft/(bound form) an opportunity/(bound form) crucial point; pivot/(bound form) quick-witted; flexible/(bound form) organic</span><br><span class=\"w-hanzi-small\">機</span>&nbsp;<span class=\"w-pinyin-small tone1\">jī</span>&nbsp;&nbsp;&nbsp;<span class=\"w-pinyin-small\">gei1</span><span style=\"float: right\" class=\"w-pinyin-small\">Cant.</span><br><span class=\"w-def-small\">(noun) device</span><br><span class=\"w-hanzi-small\">機</span>&nbsp;<span class=\"w-pinyin-small tone1\">jī</span>&nbsp;&nbsp;&nbsp;<span class=\"w-pinyin-small\">gei1</span><span style=\"float: right\" class=\"w-pinyin-small\">Cant.</span><br><span class=\"w-def-small\">machine/engine/opportunity/intention/aircraft/pivot/crucial point/flexible (quick-witted)/organic M: 台tái [台]/witty/handphone</span><br>",
        config: {
            "simpTrad": "auto"
        },
    },
    {
        ...
        expectedHTML: "<span class=\"w-hanzi-small\">机会</span>&nbsp;<span class=\"w-pinyin-small tone1\">jī</span>&nbsp;<span class=\"w-pinyin-small tone4\">huì</span>&nbsp;&nbsp;&nbsp;<span class=\"w-pinyin-small\">gei1 wui5</span><br><span class=\"w-def-small\">opportunity/chance/occasion/CL:個|个[ge4]</span><br><span class=\"w-hanzi-small\">机</span>&nbsp;<span class=\"w-pinyin-small tone1\">Jī</span>&nbsp;&nbsp;&nbsp;<span class=\"w-pinyin-small\">gei1</span><br><span class=\"w-def-small\">surname Ji</span><br><span class=\"w-hanzi-small\">机</span>&nbsp;<span class=\"w-pinyin-small tone1\">jī</span>&nbsp;&nbsp;&nbsp;<span class=\"w-pinyin-small\">gei1</span><br><span class=\"w-def-small\">(bound form) machine; mechanism/(bound form) aircraft/(bound form) an opportunity/(bound form) crucial point; pivot/(bound form) quick-witted; flexible/(bound form) organic</span><br><span class=\"w-hanzi-small\">机</span>&nbsp;<span class=\"w-pinyin-small tone1\">jī</span>&nbsp;&nbsp;&nbsp;<span class=\"w-pinyin-small\">gei1</span><span style=\"float: right\" class=\"w-pinyin-small\">Cant.</span><br><span class=\"w-def-small\">(noun) device</span><br><span class=\"w-hanzi-small\">机</span>&nbsp;<span class=\"w-pinyin-small tone1\">jī</span>&nbsp;&nbsp;&nbsp;<span class=\"w-pinyin-small\">gei1</span><span style=\"float: right\" class=\"w-pinyin-small\">Cant.</span><br><span class=\"w-def-small\">machine/engine/opportunity/intention/aircraft/pivot/crucial point/flexible (quick-witted)/organic M: 台tái [台]/witty/handphone</span><br>",
        config: {
            "simpTrad": "auto"
        },
    },
