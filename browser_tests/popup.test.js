...
test("prints out a different HTML when hovering over 有 in an HTML-rich site with a custom config set up", async () => {
    ...
    expect(windowHTML).toEqual("<span class=\"w-hanzi\">有</span>&nbsp;<br><span class=\"tone3 w-zhuyin\">ㄧㄡˇ</span><br><span class=\"w-def\">to have; there is/(bound form) having; with; -ful; -ed; -al (as in 有意[you3yi4] intentional)</span><br>")
})
