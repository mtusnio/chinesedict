...
async function getDictionary() {
    ...
    return localStorage["dictionaryContent"]
}
...
async function loadDictionary() {
    ...
    const dict = new ZhongwenDictionary([{
        type: "common",
...
async function deactivateExtension() {
    ...
    await chrome.storage.local.set({ "enabled": false, "dictionaryContent": null })
    isActive = false
