        ...
        dictionaries.forEach((dictionary) => {
            ...
            lines.forEach((line) => {
                ...
                if (tokens) {
                    ...
                    const allEntries = dictContents.get(traditionalKey) || [];
                    const entry = {
                    ...
                    dictContents.set(traditionalKey, allEntries);
                    dictContents.set(simplifiedKey, allEntries);
                }
            });
        });

        return new ZhongwenDictionary(dictContents);
    }
